<script lang="ts">
  ...
  const sideMap = {
    ...
    bottom: "animate-in slide-in-from-bottom w-full duration-300 ease-in-out data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom",
    ...
    right: "animate-in slide-in-from-right h-full duration-300 ease-in-out data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right"
  };
