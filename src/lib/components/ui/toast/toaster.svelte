...
<div class="fixed bottom-0 left-0 z-[100] flex w-full flex-col gap-2 p-4 md:max-w-sm">
	{#each $toasts as toast (toast.id)}
		<div
			class="overflow-hidden rounded-lg border shadow-lg {getVariantClasses(toast.variant)}"
			role="alert"
